...
public class LoggedOutClient {
    ...
    public String eval(String userInput, UserState state) throws ResponseException, UIException {
        ...
        return switch (cmd) {
            case "Quit" -> "Quit";
            case "Help" -> help();
            case "Login" -> login(state, params);
            case "Register" -> register(params);
            case "Delete" -> delete(state, params);
    ...
    private String login(UserState state, String... params) throws UIException, ResponseException {
        if (params.length == 2) {
    ...
    private String delete(UserState state, String... params) throws UIException, ResponseException {
